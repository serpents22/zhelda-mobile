...
public class SetupDayNightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        daynightTitle = findViewById(R.id.daynightTitle);
    ...
    protected void onResume() {
        ...
        if( getIntent().getStringExtra("type").equals("A")){
            daynightTitle.setText("Programma Zona Giorno");
        } else {
            daynightTitle.setText("Programma Zona Notte");
        }
